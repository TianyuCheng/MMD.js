...
(function() {
  ...
  this.MMD.Renderer = (function() {
    function Renderer(mmd, model) {
      this.mmd = mmd;
      this.model = model;
      this.gl = this.mmd.gl;
      this.program = this.mmd.program;
      this.vbuffers = {};
      this.initVertices();
      this.initIndices();
      this.initTextures();
    ...
    Renderer.prototype.initVertices = function() {
    ...
    Renderer.prototype.initIndices = function() {
      var indices;
    ...
    Renderer.prototype.renderMaterial = function(material, offset) {
      var textures;
    ...
    Renderer.prototype.renderEdge = function(material, offset) {
    ...
    Renderer.prototype.setSelfShadowTexture = function() {
    ...
    Renderer.prototype.moveMorphs = function(model, morphs) {
    ...
    Renderer.prototype.moveBones = function(model, bones) {
